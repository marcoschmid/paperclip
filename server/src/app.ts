...
import { registerPluginWorkerStartupReadiness } from "./services/plugin-worker-manager.js";
...
export async function createApp(
  ...
  registerPluginWorkerStartupReadiness(workerManager, bundledPluginsStartup);
