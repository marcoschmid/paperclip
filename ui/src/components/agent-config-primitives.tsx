...
export const help: Record<string, string> = {
  ...
  dangerouslySkipPermissions: "Adapter-specific unattended permission mode. Claude rejects the global form and free-form allowedTools; only Board-managed scopes may authorize tools.",
  dangerouslyBypassSandbox: "Legacy global Codex approvals/sandbox bypass. Paperclip rejects this mode because its declared scope cannot be enforced.",
